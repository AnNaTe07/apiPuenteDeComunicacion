...
namespace apiPuenteDeComunicacion.Migrations
{
    ...
    [Migration("20241111013850_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApiPuenteDeComunicacion.Models.Actividad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiPuenteDeComunicacion.Models.Asistencia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiPuenteDeComunicacion.Models.Calificacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiPuenteDeComunicacion.Models.EstadoAsistencia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiPuenteDeComunicacion.Models.Materia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiPuenteDeComunicacion.Models.Notificacion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiPuenteDeComunicacion.Models.TipoActividad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ApiPuenteDeComunicacion.Models.Actividad", b =>
                {
                    b.HasOne("ApiPuenteDeComunicacion.Models.Notificacion", "Notificacion")
                        .WithMany()
                        .HasForeignKey("NotificacionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApiPuenteDeComunicacion.Models.TipoActividad", "TipoActividad")
                        .WithMany()
            ...
            modelBuilder.Entity("ApiPuenteDeComunicacion.Models.Asistencia", b =>
                {
                    b.HasOne("ApiPuenteDeComunicacion.Models.Actividad", null)
                        .WithMany("Asistencias")
                        .HasForeignKey("ActividadId");

                    b.HasOne("ApiPuenteDeComunicacion.Models.Alumno", "Alumno")
                        .WithMany()
                        .HasForeignKey("AlumnoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ApiPuenteDeComunicacion.Models.EstadoAsistencia", "Estado")
                        .WithMany()
            ...
            modelBuilder.Entity("ApiPuenteDeComunicacion.Models.Calificacion", b =>
                {
                    ...
                    b.HasOne("ApiPuenteDeComunicacion.Models.Materia", "Materia")
                        .WithMany()
            ...
            modelBuilder.Entity("ApiPuenteDeComunicacion.Models.Curso", b =>
                {
                    ...
                    b.HasOne("ApiPuenteDeComunicacion.Models.Notificacion", null)
                        .WithMany("Cursos")
                        .HasForeignKey("NotificacionId");
